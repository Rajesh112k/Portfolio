  ...
  return (
    <section className="portfolioPage">
      <div className="container-fluid">
        ...
        <p className="intro text-center mt-4 text-light">
        ...
        <div className="wrapper mt-5 d-flex align-items-center justify-content-center flex-wrap">
          {projects.map((proj, index) => (
            <div className="box position-relative" key={index}>
              <Image src={proj.image} alt={proj.title} layout="responsive" objectFit="cover" className="project-image" />
        ...
        <div className="skills-section mt-5 text-center">
          <h2 className="text-light mb-4">Tools & Technologies</h2>
          <div className="d-flex justify-content-center flex-wrap">
            {skills.map((skill, idx) => (
              <span className="badge skill-badge m-2" key={idx}>{skill}</span>
            ))}
          </div>
        </div>
      </div>
